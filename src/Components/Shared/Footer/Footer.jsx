  ...
  return (
    <div>
      <footer className="text-gray-600 body-font">
        <div className="container  bg-gradient-to-r from-purple-300 to-pink-300 px-20 py-24 mx-auto ">
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-gray-900 tracking-widest text-sm mb-3">CATEGORIES</h2>
              <nav className="list-none mb-10">
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">Laravel</Link>
                </li>
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">Java</Link>
                </li>
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">Javascript</Link>
                </li>
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">Html</Link>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-gray-900 tracking-widest text-sm mb-3">Pages</h2>
              <nav className="list-none mb-10">
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">About</Link>
                </li>
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">Blogs</Link>
                </li>
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">Faq</Link>
                </li>
                <li>
                  <Link className="text-gray-600 hover:text-gray-800">Courses</Link>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-gray-900 tracking-widest text-sm mb-3">Intructions</h2>
              <nav className="list-none mb-10">
                <li>
        ...
        <div className="bg-gradient-to-r from-pink-300  to-purple-300">
          <div className="container px-5 py-2 mx-auto flex items-center sm:flex-row flex-col">
            <Link className="flex title-font font-bold items-center md:justify-start justify-center text-gray-900">
              <img className="w-24" src={logo} alt="" />
              <span className="ml-3 text-xl">z8-Tech</span>
            </Link>
            <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023 Z8-tech —
              <Link href="/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">CMS system</Link>
            </p>
