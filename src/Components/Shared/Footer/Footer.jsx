          ...
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Laravel</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Java</a>
                </li>
                <li>
        ...
        <div className="bg-gradient-to-r from-pink-300  to-purple-300">
          <div className="container px-5 py-2 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023 Z8-tech —
              <a href="/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">CMS system</a>
            </p>
