                ...
                <section className="text-gray-600 body-font overflow-hidden">
                    <div className="container px-5 py-24 mx-auto">
                        <div className="lg:w-4/5 mx-auto flex flex-wrap">
                            ...
                            <div className="lg:w-1/2 mb-48  w-full   ">
                                <video alt="ecommerce" className=" w-full  h-96 object-cover object-center rounded" controls>
                                    <source src="https://youtu.be/16L5XUYySxM" type="video/mp4" />
                                    Your browser does not support the video tag.
                                </video>
                                <div>
                                    <details className="collapse collapse-arrow bg-base-200 my-4">
                            ...
                            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Microservices with Node JS and React</h1>
